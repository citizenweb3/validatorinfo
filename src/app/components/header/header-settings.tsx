  ...
  return (
    <div className="flex flex-row items-center space-x-1">
      <Button onClick={() => setTheme(resolvedTheme === 'dark' ? 'light' : 'dark')}>
        {resolvedTheme === 'dark' ? (
          <svg className="h-4" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path
          ...
          <svg className="h-4" width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            <path
              opacity="0.9"
      ...
      <Button className="text-xs">USD</Button>
    </div>
  );
};
