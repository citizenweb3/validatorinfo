...
import MetricsChartLine from '@/app/validators/[identity]/(validatorProfile)/metrics/metrics-chart';
import MetricsBlocks from '@/app/validators/[identity]/(validatorProfile)/metrics/metrics-blocks/metrics-blocks';
