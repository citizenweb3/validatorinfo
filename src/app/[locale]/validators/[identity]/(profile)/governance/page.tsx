...
import ValidatorCreatedProposalsBar from '@/app/validators/[identity]/(profile)/governance/created-proposals-bar';
import ValidatorVotes from '@/app/validators/[identity]/(profile)/governance/validator-votes/validator-votes';
