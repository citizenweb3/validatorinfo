...
import ValidatorCreatedProposalsBar from '@/app/validators/[id]/(validatorProfile)/governance/created-proposals-bar';
import ValidatorVotes from '@/app/validators/[id]/(validatorProfile)/governance/validator-votes/validator-votes';
