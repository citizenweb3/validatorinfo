  ...
  return (
    <div className="space-y-4 text-sm">
      {!!results?.validators.length && (
        <div>
          <div className="sm:text-lg text-4xl text-highlight">{t('search.Validators')}</div>
          <div>
      ...
      {!!results?.chains.length && (
        <div>
          <div className="sm:text-lg text-4xl text-highlight">{t('search.Networks')}</div>
          <div>
      ...
      {!!results?.tokens.length && (
        <div>
          <div className="sm:text-lg text-4xl text-highlight">{t('search.Tokens')}</div>
          <div>
