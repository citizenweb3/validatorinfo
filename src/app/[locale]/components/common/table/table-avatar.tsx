      ...
      <div className="relative h-[3.3125rem] w-[3.3125rem]">
        {icon ? (
          <Image
            ...
            width={40}
            height={40}
            className="absolute left-1/2 top-1/2 z-10 h-10 w-10 -translate-x-1/2 -translate-y-1/2 transform rounded-full group-hover/avatar:shadow-2xl object-contain"
          />
        ) : (
          <Image
            ...
            width={40}
            height={40}
            className="absolute left-1/2 top-1/2 z-10 h-11 w-11 -translate-x-1/2 -translate-y-1/2 transform rounded-full group-hover/avatar:shadow-2xl"
          />
        )}
      </div>
