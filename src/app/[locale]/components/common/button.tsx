...
const activeClasses = {
  default: 'bg-gradient-to-r md:from-primary md:to-secondary active:from-transparent active:to-transparent border-transparent',
  switcher: 'border border-[#3e3e3e]',
};
