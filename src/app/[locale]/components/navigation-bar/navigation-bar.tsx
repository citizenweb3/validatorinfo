...
const NavigationBar: FC<OwnProps> = () => {
  ...
  return (
    <div
      className={`${isOpened ? 'w-[15.5rem]' : 'w-10'} relative mt-2 border-r-[1.5rem] border-transparent pt-6 font-hackernoon transition-all duration-300`}
    >
      <div
      ...
      >
        <div
          className={`${!isOpened ? 'rotate-90' : '-rotate-90'} group-active:bg-hide_a absolute -left-1 -top-4 min-h-8 min-w-6 bg-hide bg-contain group-hover:bg-hide_h`}
        />
      </div>
