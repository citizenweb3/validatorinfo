...
import { devActivityTableExampleInterface } from '@/app/networks/[name]/(network-profile)/networkProfileExample';
import DeveloperActivityTableItem
  from '@/app/networks/[name]/(network-profile)/dev/developer-activity/developer-activity-table-item';
