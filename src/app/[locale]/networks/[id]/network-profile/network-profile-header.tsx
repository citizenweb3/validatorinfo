...
import NetworkHeaderMetricsBlocks from '@/app/networks/[id]/network-profile/network-header-metrics-blocks';
...
const NetworkProfileHeader: FC<OwnProps> = async ({ id, locale }) => {
  ...
  return (
    <div className="mb-7 mt-4 grid grid-cols-5 items-start">
      <div className="col-span-1 h-full max-w-xs border-b border-bgSt">
      ...
      <div className="col-span-3 flex flex-col items-center justify-center">
        <div className={`${centerLogoSizes} relative inline-block`}>
          ...
          <div className="absolute bottom-[-30%] right-[-30%] flex h-[80%] w-[80%] flex-col items-center">
