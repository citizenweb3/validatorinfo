...
const BorrowedBarChart: React.FC<Props> = ({ data, height = 320 }) => {
        ...
        tooltip
          ...
          .html(`
            <div style="display: flex; justify-content: space-between; width: 100%; gap: 10px;">
              ...
              <span style="color: ${color}; font-weight: bold; font: 16px SF Pro Display">
                ${d.percent.toFixed(2)}%
              </span>
            </div>
          `);
...
export default BorrowedBarChart;
