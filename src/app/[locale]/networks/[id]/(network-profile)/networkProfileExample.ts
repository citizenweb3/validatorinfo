export interface devActivityTableExampleInterface {
  title: string;
  data: number;
}
...
export const networkProfileExample = {
  ...
  liveProposals: [
    {
      proposalNumber: 887,
      proposalTitle: 'Gaia v15 Software Upgrade',
      proposer: {
        title: 'proposer',
        data: 'cosmosvaloper1e859xaue4k2jzqw20cv6l7p3tmc378pc3k8g2u',
      },
      votingStart: {
        title: 'voting start',
        data: '07/03/2025, 22:01:15',
      },
      votingEnd: {
        title: 'voting end',
        data: '21/03/2025, 22:01:15',
      },
      remainingTime: {
