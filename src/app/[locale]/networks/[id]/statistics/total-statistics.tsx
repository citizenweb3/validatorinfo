      ...
      <div className="mt-7 grid grid-cols-2 gap-x-10">
        {networkProfileExample.totalStatistics.map((item) => (
          <div key={item.title} className="mt-2 flex w-full hover:bg-bgHover">
            ...
            <div className="flex w-1/2 cursor-pointer items-center justify-between gap-2 border-b border-bgSt py-4 pl-6 pr-4 font-handjet text-base hover:text-highlight">
              {item.data}
            </div>
          </div>
        ))}
