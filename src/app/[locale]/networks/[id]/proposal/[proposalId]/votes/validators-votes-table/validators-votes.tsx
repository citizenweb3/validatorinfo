...
const ValidatorsVotes: FC<OwnProps> = async ({ page, perPage, sort, currentPage, chainId, proposalId, vote, search }) => {
  return (
    <div className="mt-4">
      ...
      <div className="mb-4">
        <div
          ...
          <div>
            <ValidatorsVotesSearch chainId={chainId} proposalId={proposalId} />
          </div>
          <svg
            width="6"
            height="10"
