<template>
  <div class="w-full block mx-auto h-auto lg:max-w-2/3">
    ...
    <el-card class="mb-7.5 border-none">
      <template #header>
        <h3 class="cursor-auto mb-0 text-white">Headings</h3>
      </template>
      <div>
        <Heading />
      </div>
    ...
    <el-card class="mb-7.5 border-none">
      <template #header>
        <h3 class="cursor-auto mb-0 text-white">Display titles</h3>
      </template>
      <div>
        <DisplayTitle />
      </div>
    ...
    <el-card class="mb-7.5 border-none">
      <template #header>
        <h3 class="cursor-auto mb-0 text-white">Specialized titles</h3>
      </template>
      <div>
        <SpecializedTitle />
      </div>
    ...
    <el-card class="mb-7.5 border-none">
      <template #header>
        <h3 class="cursor-auto mb-0 text-white">Paragraphs</h3>
      </template>
      <div>
        <Paragraphs />
      </div>
