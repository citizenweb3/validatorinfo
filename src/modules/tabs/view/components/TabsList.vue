    ...
    <ul class="flex flex-nowrap justify-between pl-0 items-center">
      ...
      >
        <div
          class="h-full w-full"
          :class="{
            'bg-gradient-to-t from-apple to-lust via-americanYellow p-1':
        ...
        >
          <div class="bg-blackOlive font-main text-white p-1">
            <div
              ...
              :class="{
                'bg-gradient-to-t from-apple to-lust via-americanYellow inline-block text-transparent bg-clip-text ':
                  tab.hash === activeTabHash,
              }"
            >
              {{ tab.title }}
