<template>
  <div class="titleWrapper"><p class="title">{{data.title}}</p></div>
  <div class="contentWrapper mt-4" >
    <div v-for="(item, index) in data.data" :key="index" class='contentItem mt-5'>
...
import { GeneralInfo, StakingInfo } from 'modules/aboutUs/store/types'
...
export default defineComponent({
  ...
  props: {
    title: {
      type: String,
      default: "Staking tabs",
    },
  },
  setup() {
    const data: StakingInfo = store.aboutUs.staking;
