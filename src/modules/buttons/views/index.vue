<template>
  <div class="w-full block mx-auto h-auto lg:max-w-2/3">
    <el-card class="mb-7.5 border-none">
      <template #header>
        <h3 class="cursor-auto mb-0 text-white">Styles</h3>
      </template>
      <div>
        <StyleButtons />
      </div>
    ...
    <el-card class="mb-7.5 border-none">
      <template #header>
        <h3 class="cursor-auto mb-0 text-white">Colors</h3>
      </template>
      <div>
        <ColorButtons />
      </div>
    ...
    <el-card class="mb-7.5 border-none">
      <template #header>
        <h3 class="cursor-auto mb-0 text-white">Outline</h3>
      </template>
      <div>
        <OutlineButtons />
      </div>
    ...
    <el-card class="mb-7.5 border-none">
      <template #header>
        <h3 class="cursor-auto mb-0 text-white">Sizes</h3>
      </template>
    ...
    <el-card class="mb-7.5 border-none">
      <template #header>
        <h3 class="cursor-auto mb-0 text-white">Group</h3>
      </template>
    ...
    <el-card class="mb-7.5 border-none">
      <template #header>
        <h3 class="cursor-auto mb-0 text-white">Social</h3>
      </template>
      <div>
        <SocialButtons />
      </div>
