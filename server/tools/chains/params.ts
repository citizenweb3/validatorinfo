...
const chainParams: Record<string, AddChainProps> = {
  ...
  'cosmoshub-testnet': {
    ...
    logoUrl: 'https://raw.githubusercontent.com/cosmos/chain-registry/master/cosmoshub/images/atom.svg',
    nodes: [
      { type: 'grpc', url: 'grpc.provider.citizenweb3.com' },
      { type: 'rest', url: 'https://api.provider.citizenweb3.com' },
      { type: 'rpc', url: 'https://rpc.provider.citizenweb3.com' },
      { type: 'ws', url: 'wss://rpc.provider.citizenweb3.com/websocket' },
    ],
    mainRepo: 'https://github.com/cosmos/gaia',
    docs: 'https://cosmos.network',
    githubUrl: 'https://github.com/cosmos',
  ...
  celestia: {
    ...
    mainRepo: 'https://github.com/celestiaorg/celestia-app',
  ...
  likecoin: {
    ...
    mainRepo: 'https://github.com/likecoin/likecoin-api-public',
  ...
  stride: {
    ...
    mainRepo: 'https://github.com/Stride-Labs/stride',
  ...
  quicksilver: {
    ...
    mainRepo: 'https://github.com/quicksilver-zone/quicksilver',
  ...
  'quicksilver-testnet': {
    ...
    logoUrl: 'https://raw.githubusercontent.com/cosmos/chain-registry/master/quicksilver/images/qck.svg',
    nodes: [
      { type: 'grpc', url: 'grpc.quicksilver-testnet.citizenweb3.com' },
      { type: 'rest', url: 'https://api.quicksilver-testnet.citizenweb3.com' },
      { type: 'rpc', url: 'https://rpc.quicksilver-testnet.citizenweb3.com' },
      { type: 'ws', url: 'wss://rpc.quicksilver-testnet.citizenweb3.com/websocket' },
    ],
    mainRepo: 'https://github.com/quicksilver-zone/quicksilver',
    docs: 'https://docs.quicksilver.zone',
    githubUrl: 'https://github.com/quicksilver-zone',
  ...
  uptick: {
    ...
    mainRepo: 'https://github.com/UptickNetwork/uptick',
  ...
  gravitybridge: {
    ...
    mainRepo: 'https://github.com/Gravity-Bridge/Gravity-Bridge',
  ...
  neutron: {
    ...
    mainRepo: 'https://github.com/neutron-org/neutron',
  ...
  'neutron-testnet': {
    ...
    nodes: [
      { type: 'grpc', url: 'neutron-testnet-grpc.polkachu.com:19190' },
      { type: 'rest', url: 'https://neutron-testnet-api.polkachu.com' },
      { type: 'rpc', url: 'https://neutron-testnet-rpc.polkachu.com' },
      { type: 'ws', url: 'wss://neutron-testnet-rpc.polkachu.com/websocket' },
    ],
    mainRepo: 'https://github.com/neutron-org/neutron',
    docs: 'https://docs.neutron.org',
    githubUrl: 'https://github.com/neutron-org',
  ...
  dymension: {
    ...
    mainRepo: 'https://github.com/dymensionxyz/dymension',
  ...
  atomone: {
    ...
    mainRepo: 'https://github.com/atomone-hub/atomone',
  ...
  union: {
    ...
    nodes: [
      ...
      { type: 'ws', url: 'wss://union-mainnet.rpc.stakin.com/websocket' },
    ],
    mainRepo: 'https://github.com/unionlabs/union',
  ...
  axone: {
    ...
    nodes: [
      { type: 'grpc', url: 'grpc.axone.citizenweb3.com' },
      { type: 'rest', url: 'https://api.axone.citizenweb3.com' },
      { type: 'rpc', url: 'https://rpc.axone.citizenweb3.com' },
      { type: 'ws', url: 'wss://rpc.axone.citizenweb3.com/websocket' },

      { type: 'grpc', url: 'grpc.axone.cumulo.com.es:443' },
      { type: 'rest', url: 'https://api.axone.cumulo.com.es' },
      { type: 'rpc', url: 'https://rpc.axone.cumulo.com.es' },
      { type: 'ws', url: 'wss://rpc.axone.cumulo.com.es/websocket' },

      { type: 'rest', url: 'https://rest.nodejumper.io/axone' },
      { type: 'rpc', url: 'https://rpc.nodejumper.io:443/axone' },
      { type: 'ws', url: 'wss://rpc.nodejumper.io:443/axone/websocket' },
    ],
  ...
  symphony: {
    ...
    nodes: [
      { type: 'grpc', url: 'grpc.symphony.citizenweb3.com' },
      { type: 'rest', url: 'https://api.symphony.citizenweb3.com' },
      { type: 'rpc', url: 'https://rpc.symphony.citizenweb3.com' },
      { type: 'ws', url: 'wss://rpc.symphony.citizenweb3.com/websocket' },

      { type: 'grpc', url: 'symphony-grpc.crouton.digital:29290' },
      { type: 'rest', url: 'https://symphony-api.crouton.digital' },
      { type: 'rpc', url: 'https://symphony-rpc.crouton.digital' },
      { type: 'ws', url: 'wss://symphony-rpc.crouton.digital/websocket' },
      ...
      { type: 'rest', url: 'https://symphony-api.konsortech.xyz' },
      { type: 'rpc', url: 'https://symphony-rpc.konsortech.xyz' },
