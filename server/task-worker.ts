...
import updateTxMetrics from '@/server/jobs/update-tx-metrics';
  ...
  try {
    switch (taskName) {
      ...
      case 'update-aztec-total-earned-rewards':
        ...
        break;
      case 'update-tx-metrics':
        await updateTxMetrics(chains);
        break;
      ...
      case 'monero-network-info':
        ...
        break;
      case 'monero-pool-attribution':
        await updateMoneroPoolAttribution();
        break;
